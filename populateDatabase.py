from sampleData import pilots, destinations, aircraft, flights
...
def populate_database():
    ...
    conn.executemany("INSERT OR IGNORE INTO aircraft (aircraft_id, Airline, model, capacity) VALUES (?, ?, ?, ?)", aircraft)
